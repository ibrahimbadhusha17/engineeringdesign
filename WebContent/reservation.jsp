					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="http://127.0.0.1:5000/">Recommended</a>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Reservation</h2>
						<p>Make the Reservation of your favourite Hotel</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="contact-block">
						<form action="store1.jsp" onSubmit="store1.jsp" method="post">
							<div class="row">
								<div class="col-md-6">
									<h3>Select Restaurant</h3>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" id="name" name="hotel" placeholder="Enter Hotel Name" required data-error="Please enter your name">
	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<h3>About Us</h3>
					<p>To recommend the best hotels and rooms based on the customer comments and reviews by using sentimental analysis.</p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Opening hours</h3>
				...
				<div class="col-lg-3 col-md-6">
					...
					<p class="lead">ss colony, madurai</p>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">All Rights Reserved. &copy; 2018 <a href="#">Review Hub</a>  
